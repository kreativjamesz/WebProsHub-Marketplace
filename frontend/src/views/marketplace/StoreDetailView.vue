<template>
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Store Details -->
      <div v-if="store" class="space-y-8">
        <!-- Store Header -->
      ...
      <!-- Error State -->
      <div v-else-if="!loading && !store" class="text-center py-12">
...
import { mockStoreDetail, mockStoreProducts, mockStoreReviews } from '@/mocks'
...
const loadStoreDetails = async () => {
  ...
  try {
    ...
    store.value = mockStoreDetail
    products.value = mockStoreProducts
    reviews.value = mockStoreReviews
  } catch (error) {
