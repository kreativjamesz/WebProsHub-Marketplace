<template>
  <div class="min-h-screen flex items-center justify-center bg-background py-12 px-4 sm:px-6 lg:px-8">
    <Card class="max-w-md w-full space-y-8 bg-card border border-border">
      <!-- Header -->
      <CardHeader class="text-center">
        ...
        <h2 class="mt-6 text-3xl font-extrabold text-foreground">Welcome back to WebProsHub</h2>
      ...
      <CardContent>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                type="email"
                required
                class="mt-1 block w-full px-3 py-2 border border-border rounded-md shadow-sm placeholder-muted-foreground focus:outline-none focus:ring-ring focus:border-ring sm:text-sm bg-background text-foreground transition-colors duration-200"
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input
                ...
                type="checkbox"
                class="h-4 w-4 text-primary focus:ring-ring border-border rounded bg-background"
              />
        ...
        <div class="text-center">
          <p class="text-sm text-muted-foreground mt-4">
            ...
            <router-link to="/register" class="font-medium text-primary hover:text-primary/80 transition-colors duration-200">
              Sign up here
            </router-link>
          </p>
        </div>
        ...
        <div class="relative">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="my-4 px-2 bg-card text-muted-foreground">Or continue with</span>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-3">
          <button
            type="button"
            class="w-full inline-flex justify-center py-2 px-4 border border-border rounded-md shadow-sm bg-card text-sm font-medium text-muted-foreground hover:bg-accent transition-colors duration-200"
          >
...
:global(.dark) .bg-gradient-to-r {
  background: linear-gradient(to right, #1e40af, #7c3aed);
}

:global(.dark) .hover\:from-blue-700:hover {
  background: linear-gradient(to right, #1e3a8a, #6d28d9);
}

:global(.dark) .hover\:to-purple-700:hover {
  background: linear-gradient(to right, #1e3a8a, #6d28d9);
}
</style>
