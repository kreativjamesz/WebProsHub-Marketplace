  ...
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center">
          ...
          <p class="mt-6 max-w-2xl mx-auto text-xl text-gray-500">
            Find answers to your questions and get the support you need to make the most of our marketplace.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="py-12 bg-gray-50">
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8">
          <h2 class="text-2xl font-bold text-gray-900 mb-4">How can we help you?</h2>
          <p class="text-gray-600">Search our knowledge base for quick answers</p>
        </div>
    ...
    <div class="py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-gray-900 text-center mb-12">Quick Help Categories</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="text-sm text-blue-600 font-medium">Browse articles →</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-16 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-gray-900 text-center mb-12">Popular Help Topics</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div class="space-y-6">
            ...
            >
              <h3 class="text-lg font-medium text-gray-900 mb-2">{{ topic.title }}</h3>
              <p class="text-gray-600 mb-3">{{ topic.excerpt }}</p>
    ...
    <div class="py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-gray-900 text-center mb-12">Step-by-Step Guides</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div class="p-6">
              <h3 class="text-xl font-medium text-gray-900 mb-3">{{ guide.title }}</h3>
              <p class="text-gray-600 mb-4">{{ guide.description }}</p>
              <div class="flex items-center justify-between">
                <span class="text-sm text-gray-500">{{ guide.steps }} steps</span>
    ...
    <div class="py-16 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-gray-900 text-center mb-12">Video Tutorials</h2>
            ...
            <div class="aspect-w-16 aspect-h-9 bg-gray-200">
              <div class="flex items-center justify-center h-48">
                <div class="text-center">
                  ...
                  <p class="text-gray-500">Video thumbnail</p>
                </div>
              </div>
            </div>
            <div class="p-6">
    ...
    <div class="py-16 bg-gray-50">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <router-link
            to="/contact"
            class="px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 transition-colors duration-200"
          >
            Contact Support
          </router-link>
          <button class="px-6 py-3 border border-gray-300 text-gray-700 font-medium rounded-md hover:bg-gray-50 transition-colors duration-200">
            Live Chat
          </button>
        </div>
...
const filteredTopics = computed(() => {
  ...
  return popularTopics.value.filter(topic =>
