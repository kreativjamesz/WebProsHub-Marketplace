...
export const mockStoreDetail: Store = {
  ...
  name: 'Tech Haven',
  description:
    'Your one-stop shop for all things technology. We offer the latest gadgets, electronics, and tech accessories with competitive prices and excellent customer service.',
...
export const mockStoreReviews = mockReviews.filter((r) => r.productId === '1')
